package com.adp.generator.util;
...
import com.adp.generator.config.GenConfig;
...
public class GenUtils
{
    ...
    public static void initColumnField(GenTableColumn column, GenTable table)
    {
        ...
        String dataPrecision = column.getDataPrecision();
        ...
        if (arraysContains(GenConstants.COLUMNTYPE_STR, dataType)){
            ...
            if (StringUtils.isNotBlank(dataPrecision)){ // 浮点型
